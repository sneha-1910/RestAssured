...
public class Using_POM_ThrreLayer extends BaseClass_Api {
     WebDriver driver;
	
   @Test
	public void create() throws IOException, InterruptedException, SQLException
	{   
       ...
       baseURI=IpathConstants.appURL;
        ...
        .when().get(EndPointLibrary.getSingleProject+"{ProID1}")
